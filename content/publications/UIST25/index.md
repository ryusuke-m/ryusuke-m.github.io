---
title: A Display Method Visible Only During Gaze Fixation on Moving Objects using
...
abstract: 'We present a novel display method that can be perceived only when users
  ...
  to their gaze direction. In this paper, we describe the proposed method and demonstrate
  the technique through two gaze-dependent applications: a finger-tracing display
  that reveals content only when users slide their gaze across the surface while tracing
